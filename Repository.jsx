...
export default function Repository({ name, language, description, forks_count, stargazers_count, inputvalue }) {

    const handleclick = () => {
        window.open(`http://github.com/${inputvalue}/${name}`);
    }


    return (

        <div className="flex flex-row mt-10 transition translate-y-1 hover:scale-110 shadow-lg cursor-pointer rounded-2xl" onClick={handleclick}>
